...
public class DidarRetro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_didar_retro);
    ...
    private void writeTv(String response){
        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                Toast.makeText(DidarRetro.this, obj.optString("message")+"", Toast.LENGTH_SHORT).show();
            }
